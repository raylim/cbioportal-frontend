...
export function resolveClinicalDataSortAttributeId(
    ...
    const attribute = clinicalAttributes.find(
        candidate =>
            candidate.displayName === field ||
            getClinicalAttributeDisplayName(candidate) === field
    );
    ...
    get clinicalDataSortAttributeId(): string | undefined {
        switch (this.clinicalDataSortCriteria?.field) {
            ...
            case 'Sample ID':
                return 'sampleId';
            default:
                return resolveClinicalDataSortAttributeId(
