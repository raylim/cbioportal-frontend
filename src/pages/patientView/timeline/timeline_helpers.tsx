...
function organizeDataIntoTracks(
    ...
    // Clinical attribute values are user-controlled strings. A null-prototype
    // map prevents values such as "constructor" and "__proto__" from resolving
    // to inherited object members instead of event buckets.
